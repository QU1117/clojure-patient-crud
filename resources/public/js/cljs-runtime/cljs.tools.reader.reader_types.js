...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11360 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11360(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11364 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11364(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11365 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11365(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11366 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11366(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11368 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11368(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11369 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11369(reader);
}
});
...
var G__11402 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11403 = s.append(c);
c = G__11402;
s = G__11403;
continue;
}
