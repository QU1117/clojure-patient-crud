...
var G__11682 = request;
var G__11683 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__11682,G__11683) : ajax.formats.get_format.call(null,G__11682,G__11683));
} else {
...
return cljs.core.some((function (p1__11688_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__11688_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__11692){
var map__11693 = p__11692;
var map__11693__$1 = cljs.core.__destructure_map(map__11693);
var request = map__11693__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11693__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__11695 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__11695.cljs$core$IFn$_invoke$arity$1 ? fexpr__11695.cljs$core$IFn$_invoke$arity$1(response) : fexpr__11695.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__11697){
var map__11698 = p__11697;
var map__11698__$1 = cljs.core.__destructure_map(map__11698);
var request = map__11698__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11698__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__11696_SHARP_){
return ajax.formats.get_accept_entries(request,p1__11696_SHARP_);
