...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11608 = c;
var G__11608__$1 = (((G__11608 == null))?null:G__11608.prototype);
if((G__11608__$1 == null)){
return null;
} else {
return G__11608__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11609 = c;
var G__11609__$1 = (((G__11609 == null))?null:G__11609.prototype);
if((G__11609__$1 == null)){
return null;
} else {
return G__11609__$1.render;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__11614 = c;
var G__11614__$1 = (((G__11614 == null))?null:G__11614.constructor);
if((G__11614__$1 == null)){
return null;
} else {
return G__11614__$1.displayName;
}
})();
...
var G__11615 = c;
var G__11615__$1 = (((G__11615 == null))?null:G__11615.constructor);
if((G__11615__$1 == null)){
return null;
} else {
return G__11615__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__11616 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11617 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11617);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11616);
}});
...
var c = this;
var G__11626_11720 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__11626_11720 == null)){
} else {
reagent.ratom.dispose_BANG_(G__11626_11720);
}
...
var renders_11722 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_11723 = cljs.core.first(cljs.core.vals(renders_11722));
...
if((cljs.core.count(renders_11722) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_11722))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_11723)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11723], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__11634 = o;
reagent.impl.component.goog$module$goog$object.set(G__11634,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__11704 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11705 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11705);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11704);
}});
...
var vec__11706 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11706,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11706,(1),null);
...
var G__11709 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__11709 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__11709);
}
});
}),[]);
