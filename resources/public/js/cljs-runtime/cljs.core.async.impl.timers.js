...
var i_13310 = (self__.level + (1));
while(true){
if((i_13310 <= (new_level + (1)))){
(update[i_13310] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_13312 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13312[i]));
} else {
x__$2.forward.push((((i < links_13312.length))?(links_13312[i]):null));
}

if((i < links_13312.length)){
(links_13312[i] = x__$2);
} else {
links_13312.push(x__$2);
}
...
var i_13314 = (0);
while(true){
if((i_13314 <= self__.level)){
var links_13315 = (update[i_13314]).forward;
if((x__$1 === (((i_13314 < links_13315.length))?(links_13315[i_13314]):null))){
(links_13315[i_13314] = (x__$1.forward[i_13314]));

var G__13318 = (i_13314 + (1));
i_13314 = G__13318;
continue;
} else {
var G__13319 = (i_13314 + (1));
i_13314 = G__13319;
continue;
}
} else {
