...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_19260 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_19260(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_19261 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_19261(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_19262 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_19262(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_19263 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_19263(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_19264 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_19264(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_19266 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_19266(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__19258,callback){
var map__19259 = p__19258;
var map__19259__$1 = cljs.core.__destructure_map(map__19259);
var input = map__19259__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19259__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19259__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
