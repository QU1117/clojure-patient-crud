...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_11517 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_11517(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_11518 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_11518(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_11519 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_11519(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_11520 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_11520(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_11525 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_11525(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_11526 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_11526(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_11528 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_11528(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_11529 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_11529(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_11534 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_11534(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_11535 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_11535(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k11503,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k11503,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__11508){
var vec__11509 = p__11508;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11509,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11509,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__11502){
var self__ = this;
var G__11502__$1 = this;
return (new cljs.core.RecordIter((0),G__11502__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this11504,other11505){
var self__ = this;
var this11504__$1 = this;
return (((!((other11505 == null)))) && ((((this11504__$1.constructor === other11505.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11504__$1.status,other11505.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11504__$1.body,other11505.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11504__$1.status_text,other11505.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11504__$1.headers,other11505.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11504__$1.was_aborted,other11505.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11504__$1.__extmap,other11505.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k11503){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k11503);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__11502){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__11513 = cljs.core.keyword_identical_QMARK_;
var expr__11514 = k__5352__auto__;
if(cljs.core.truth_((pred__11513.cljs$core$IFn$_invoke$arity$2 ? pred__11513.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__11514) : pred__11513.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__11514)))){
return (new ajax.protocols.Response(G__11502,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__11513.cljs$core$IFn$_invoke$arity$2 ? pred__11513.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__11514) : pred__11513.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__11514)))){
return (new ajax.protocols.Response(self__.status,G__11502,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__11513.cljs$core$IFn$_invoke$arity$2 ? pred__11513.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__11514) : pred__11513.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__11514)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__11502,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__11513.cljs$core$IFn$_invoke$arity$2 ? pred__11513.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__11514) : pred__11513.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__11514)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__11502,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__11513.cljs$core$IFn$_invoke$arity$2 ? pred__11513.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__11514) : pred__11513.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__11514)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__11502,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__11502),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__11502){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__11502,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__11506){
var extmap__5385__auto__ = (function (){var G__11516 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__11506,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__11506)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__11516);
} else {
return G__11516;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__11506),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__11506),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__11506),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__11506),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__11506),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
